...
uint32_t readRPM(){
    ...
    //while(1){
        ...
        float T = (float)period/800000.0; //1550000.0; //800000.0; //690000.0;//690000.0;//700000;//700000.0;//(1 / 20000000.0); 800000.0
...
void pwm_ut(uint8_t duty){
	...
	PORTC.DIR = PIN0_bm;
	PORTMUX.TCAROUTEA = PORTMUX_TCA0_PORTC_gc; //sl?r p? pwm output p? portd
